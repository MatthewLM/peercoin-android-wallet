...
import com.matthewmitchell.peercoinj.protocols.payments.PaymentRequestException.PkiVerificationException;
		...
		public void parse()
		{
			...
			else if (input.startsWith("ppcoin:"))
			{
				try
				{
					...
					if (address == null)
						throw new PeercoinURIParseException("missing address");
